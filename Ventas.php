...
<body style="background-color: #8470e7;">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            ...
            <div class="card">
                <img src="img/CarroLogin.jpg" class="card-img-top" alt="Producto 1">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="img/CarroLogin.jpg" class="card-img-top" alt="Producto 2">
                <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                <img src="img/CarroLogin.jpg" class="card-img-top" alt="Producto 3">
                <div class="card-body">
